...
export const en: Translations = {
  ...
  locationSelection: {
    ...
    titleSuffix: 'today?',
    subtitle: 'Share empty seats and split travel costs on your commute.',
    heroBadge: 'Offer a Ride',
    startLabel: 'Pickup location',
    startPlaceholder: 'Search pickup location...',
    destinationLabel: 'Drop-off destination',
    destinationPlaceholder: 'Search destination...',
    continueJourney: 'Find Routes',
    contextualInfo: 'Ride with verified partners.',
    recentRidesTitle: 'Recent Routes',
    minDistanceError: 'Pickup and drop locations must be at least 5 km apart for intercity rides.',
    minDistanceErrorTitle: 'Route Too Short',
    localTab: 'City Ride',
    intercityTab: 'Intercity',
    minDistanceErrorIntracity: 'Pickup and drop locations must be at least 2 km apart for city rides.',
  },
  mapPicker: {
  ...
  priceSelection: {
    ...
    frontSeatPremiumDesc: 'Extra contribution, rounded to the nearest ₹10',
    ...
    basePlusPremium: 'Includes this leg’s share of the rounded front-seat premium',
    intracitySubtitle: 'Suggested city fare based on distance.',
    intracityBadge: 'City Fare',
  },
  requestType: {
  ...
  bookRideInfo: {
    ...
    travelDateLabel: 'Departure',
    datePlaceholder: 'Today',
    peopleCountLabel: 'Passengers',
    ...
    local: 'Local',
    intercity: 'Intercity',
    cityToCityTitle: 'City to City',
    cityToCitySubtitle: 'Intercity (Outstation)',
    withinCityTitle: 'Within City',
    withinCitySubtitle: 'Intracity (Local Ride)',
    localServiceArea: 'Local Service Area',
    requestLocalPartner: 'Request Local Partner',
    searchRadiusLabel: 'Search Radius',
    searchRadiusSub: 'Pickup & dropoff match distance',
    searchRadiusUnit: 'km',
  },
  availableRides: {
  ...
  activeRideDriver: {
    ...
    stopsTitle: 'STOPS',
    pickupSubtitle: 'Pickup • {{location}}',
    pickupDistanceSubtitle: 'Pickup • {{distance}} away',
    vehicleStatus: '{{vehicle}} • {{license}}',
    batteryRemaining: '{{percent}}% Battery Remaining',
    safetyCenter: 'Safety Center',
    callUser: 'Call {{name}}',
    chatUser: 'Chat with {{name}}',
    ...
    liveLocationInactive: 'Location off • Waiting at stop',
    liveLocationSubtitleOn: 'Only your real-time arrival time and distance are shared with co-passengers.',
    liveLocationSubtitleOff: 'Share arrival time and distance so passengers know when you pull up.',
    liveLocationBadge: 'LIVE',
    distanceAndEtaFromStop: '{{distance}} • {{eta}} to stop',
    atStoppageReady: 'At stoppage • Ready',
    waitingAtStop: 'Waiting at stoppage',
    distanceToPickupLabel: 'DISTANCE TO PICKUP',
    etaToPickupLabel: 'ETA TO PICKUP',
    copyLocation: 'Copy',
    copiedLocation: 'Copied',
    openInMap: 'Map',
    seatsCount: '{{count}} Seat',
    seatsCountPlural: '{{count}} Seats',
    verifiedVehicle: 'Verified Vehicle',
    atStop: 'At stop',
    chat: 'Chat',
    call: 'Call',
    passengersToPickup: 'PASSENGERS AT THIS STOP ({{count}})',
    pickupSummary: '{{passengers}} Pickups • {{seats}} Seats',
  },
  activeRidePassenger: {
    screenTitle: 'Active Ride',
    driverArrivingIn: 'DRIVER IS ARRIVING IN',
    mins: 'mins',
    min: 'min',
    distanceLabel: 'Distance: {{km}} km',
    shareMyLocation: 'Share My Location',
    liveLocationSubtitleOn: 'Only your real-time time and distance are shared with the driver.',
    liveLocationSubtitleOff: 'Share time and distance so the driver knows when you will reach the stop.',
    liveLocationBadge: 'LIVE',
    driverTitle: 'YOUR DRIVER',
    vehicleTitle: 'RIDE VEHICLE',
    chat: 'Chat',
    call: 'Call',
    timelineTitle: 'TIMELINE',
    ...
    safetyEmergencyCenter: 'Safety & Emergency Center',
    arrivingAt: 'Arriving at {{stop}}',
    copyLocation: 'Copy',
    copiedLocation: 'Copied',
    openInMap: 'Map',
  },
  activeRideBanner: {
    aboutToStartTitle: 'Your ride is about to start',
    inProgressTitle: 'Active Ride in Progress',
    subtitle: 'Tap to view live tracking & ETA',
    trackButton: 'Track Ride',
  },
};
