...
export const en: Translations = {
  ...
  travelPreferences: {
    ...
    manualApprovalDescr: 'Approve each booking request manually',
    waitingTime: 'Wait for Passengers',
    waitingTimeDescr: 'Max time you will wait at stops',
  ...
  priceSelection: {
    ...
    multiStopTitle: 'Route Pricing',
    multiStopSubtitle: 'You have {count} stops between your start and destination.',
    customizePricing: 'Customize prices per stop-to-stop leg',
  ...
  rideInformation: {
    title: 'Ride Details',
    distanceRemaining: '{distance} km remaining',
    driverInfoTitle: 'Your Driver',
    carInfoTitle: 'Vehicle',
    timelineTitle: 'Journey Route',
    rulesTitle: 'Journey Comfort',
    amenitiesTitle: 'Amenities',
    fareDetailsTitle: 'Your Fare',
    seatFareLabel: 'Seat fare per person',
    serviceFeeLabel: 'No hidden fees',
    sustainabilityFeeLabel: 'Sustainability offset',
    bookSeatButton: 'Book My Seat',
    guidelinesNote:
