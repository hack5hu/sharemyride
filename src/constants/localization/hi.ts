...
export const hi: Translations = {
  ...
  bookRideInfo: {
    ...
    peopleCountLabel: 'लोगों की संख्या',
  ...
  rideInformation: {
    title: 'सवारी विवरण',
    distanceRemaining: '{distance} किमी शेष',
    driverInfoTitle: 'आपका ड्राइवर',
    carInfoTitle: 'वाहन',
    timelineTitle: 'यात्रा मार्ग',
    rulesTitle: 'यात्रा आराम',
    amenitiesTitle: 'सुविधाएं',
    fareDetailsTitle: 'आपका किराया',
    seatFareLabel: 'प्रति व्यक्ति सीट किराया',
    serviceFeeLabel: 'कोई छुपे शुल्क नहीं',
    sustainabilityFeeLabel: 'स्थायित्व ऑफसेट',
    bookSeatButton: 'मेरी सीट बुक करें',
    guidelinesNote: 'बुकिंग करके आप हमारे दिशानिर्देशों से सहमत हैं।',
    noSmoking: 'धूम्रपान मुक्त यात्रा',
    petsAllowed: 'पालतू जानवर स्वागत',
    freeWifi: 'मुफ़्त Wi-Fi',
    usbCharging: 'USB चार्जिंग',
    fellowTravelers: 'साथी यात्री',
    journeyComfort: 'यात्रा आराम',
    seatsOpen: 'सीटें उपलब्ध',
    departure: 'प्रस्थान',
    journey: 'यात्रा',
    seatsLeft: 'शेष सीटें',
  },
